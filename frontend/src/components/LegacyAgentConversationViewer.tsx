...
interface LegacyAgentConversationViewerProps {
...
const LegacyAgentConversationViewer: React.FC<LegacyAgentConversationViewerProps> = ({
  conversations = [],
  processingSteps = [],
  qualityMetrics,
  isVisible,
    ...
    <div className="agent-conversation-overlay">
      <div className="agent-conversation-modal">
        <div className="modal-header">
          <h2>🤖 Detalles del Procesamiento Multi-Agente (Legacy)</h2>
...
export default LegacyAgentConversationViewer;